...
func DefaultSetupSteps() []Step {
	return []Step{
		...
		{Label: "Server: install ARC zsh prompt"},
		{Label: "Server: install ARC tmux config"},
		{Label: "Server: install zsh"},
		{Label: "Server: set zsh as default shell for arc"},
		...
		{Label: "Local: install zsh"},
		{Label: "Local: set zsh as default shell"},
